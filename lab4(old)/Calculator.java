...
public class Calculator implements Calculate {
    ...
    public class MemActList implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if(source instanceof JButton) {
                JButton jb=(JButton) source;
                if((jb.getText().equals("MW"))) //MTO запись в память
                {
                    memory=Double.parseDouble(str.getText());
                }
                if((jb.getText().equals("MR"))) //MFROM чтение из памяти
                {
                    str.setText(memory+"");
                }
            }
    ...
    public void chk(tempCom tc) {
        ...
        if (tc.equals(tempCom.plus)) {
                res = plus(Double.parseDouble(str.getText()));
            }
        if (tc.equals(tempCom.minus)) {
                res=minus(Double.parseDouble(str.getText()));

            }
        if (tc.equals(tempCom.divide)) {
            res=divide(Double.parseDouble(str.getText()));

            }
            if (tc.equals(tempCom.multiple)) {
            res=multiple(Double.parseDouble(str.getText()));
